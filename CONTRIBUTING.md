# Contributing to pkg-rpm-ftmdaemon
...
1. [Fork](https://github.com/qualcomm-linux/pkg-rpm-ftmdaemon/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-rpm-ftmdaemon.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/pkg-rpm-ftmdaemon.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/pkg-rpm-ftmdaemon/pulls) from your branch to `main`.
